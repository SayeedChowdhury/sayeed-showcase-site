        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            <p className="text-lg text-portfolio-gray mb-6">
              I'm looking for full time opportunities as ML engineer, researcher or data scientist. 
              Whether you have a suitable role, have a question or just want to say hello, please ping me. I'll do my best to get back to you as soon as possible.
            </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-portfolio-gray flex items-center">
                  ...
                  <a href="mailto:turjo11@gmail.com" className="hover:text-portfolio-blue transition-colors">
                    turjo11@gmail.com
                  </a>
                </p>
              </div>
              <div>
                ...
                <p className="text-portfolio-gray">West Lafayette, IN, United States</p>
              </div>
              <div>
                ...
                <div className="flex space-x-4 mt-2">
                  ...
                  <a href="https://github.com/SayeedChowdhury" target="_blank" rel="noopener noreferrer" className="text-portfolio-gray hover:text-portfolio-blue transition-colors">
